...
from stable_baselines3.maddpg.maddpg_countbased import MADDPG
...
maddpg = MADDPG(env, tensorboard_log=tensorboard_log, seed=seed, load_model=load_model, countbased_beta=countbased_beta, 
