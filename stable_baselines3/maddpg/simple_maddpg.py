    ...
    def collect_rollouts(
        ...
        while total_steps < n_steps or total_episodes < n_episodes:
            ...
            while not all(done_n):
                ...
                print("simplemaddpg: ", action_n, reward_n, done_n, infos_n)
                # with open('../heatmap/simple/nobonus_40000.csv', 'a') as fn:
                #         wn = csv.writer(fn, dialect='excel')
                #         entity_pos = []
                #         for a in new_obs_n:
            ...
            #TODO: Env Never Done!!! Change to every episode has horizon timestep.
            if horizon and self.policy_n[0].num_timesteps % horizon == 0:
                total_episodes += 1
                for i in range(len(self.policy_n)):
