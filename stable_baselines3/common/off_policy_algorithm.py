...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _setup_learn(
        ...
        horizon: int=-1, #add for maximum timestep
        ...
        return super()._setup_learn(
            total_timesteps, eval_env, horizon, callback, eval_freq, n_eval_episodes, log_path, reset_num_timesteps, tb_log_name
        )
    ...
    def _dump_logs(self) -> None:
        ...
        # logger.record("time/timesteps horizon", self.horizon, exclude="tensorboard")
        logger.record("time/total timesteps", self.num_timesteps, exclude="tensorboard")
        logger.record("reward/ episode_reward", self._horizon_reward)
        if self.use_sde:
        ...
        # Change to episode for the horizon
