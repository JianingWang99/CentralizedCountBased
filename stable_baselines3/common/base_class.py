...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        if env is not None:
            ...
            env = self._wrap_env(env, self.verbose, monitor_wrapper, self.agent_id)
    ...
    @staticmethod
    def _wrap_env(env: GymEnv, verbose: int = 0, monitor_wrapper: bool = True, agent_id: int = 0) -> VecEnv:
        """ "
        ...
        if not isinstance(env, VecEnv):
            ...
            env = DummyVecEnv([lambda: env], agent_id, env.n)
    ...
    def _setup_learn(
        ...
        horizon: int = -1, #add for maximum timesteps
